...
add_action( 'widgets_init', function(){return register_widget("LzwmeWidgetAuthor");});

class LzwmeWidgetAuthor extends WP_Widget {
    function __construct() {
        $widget_ops = array(
            'classname' => 'lzwme_widget_author',
            'name'        => 'lzwme - 作者简介',
            'description' => '主题特色组件 - 作者简介'
        );
        // parent::WP_Widget( false, false, $widget_ops );
        // $widget_ops = array( 'classname' => 'lzwme_widget_author', 'description' => '显示作者的信息简介' );
        parent::__construct( false, 'lzwme - 作者简介', $widget_ops );
    }
